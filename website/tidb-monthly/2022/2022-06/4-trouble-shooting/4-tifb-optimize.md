...
![用户响应时间](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/user_response_time_cn-1655340057128.png)
...
具体的分析诊断方法和工具，请参考[性能优化方法](https://docs.pingcap.com/zh/tidb/stable/performance-tuning-methods)。

### 第 4 步：提出优化方案，评估每种方案的收益、风险和成本

通过性能分析确定系统瓶颈点之后，根据实际情况提出低成本、低风险、并能获得最大的收益的优化方案。

根据 [阿姆达尔定律](https://zh.wikipedia.org/wiki/阿姆达尔定律)，性能优化的最大收益，取决于优化的部分在整个系统的占比。因此，你需要根据性能数据，确认系统瓶颈和相应的占比，预估瓶颈解决或者优化之后的收益。
