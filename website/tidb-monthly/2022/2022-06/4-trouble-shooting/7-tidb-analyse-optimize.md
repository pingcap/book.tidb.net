...
本文介绍了基于数据库时间的系统优化方法，以及如何利用 TiDB [Performance Overview 面板](https://docs.pingcap.com/zh/tidb/stable/grafana-performance-overview-dashboard)进行性能分析和优化。
...
![数据库时间分解图](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/dashboard-diagnostics-time-relation-1655341128849.png)
...
![TPC-C](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tpcc_db_time-1655341130727.png)
...
![OLTP](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_normal_db_time-1655341130665.png)
...
![OLTP](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_long_compile_db_time-1655341130004.png)
...
![OLTP](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_lock_contention_db_time-1655341128849.png)
...
通过观察 Performance Overview 里的以下三个面板，可以了解应用的负载类型，与 TiDB 的交互方式，以及是否能有效地利用 TiDB 的[执行计划缓存](https://docs.pingcap.com/zh/tidb/stable/sql-prepared-plan-cache)。
...
![TPC-C](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tpcc_qps-1655341130378.png)
...
![OLTP-Query](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_long_compile_qps-1655341129331.png)
...
![OLTP-Prepared](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_prepared_statement_no_plan_cache-1655341129522.png)
...
![TPC-C](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tpcc_kv_conn-1655341129282.png)
...
![OLTP](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_long_idle_kv_conn-1655341130099.png)
...
![TPC-C](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tidb_high_cpu-1655341130723.png)
...
![TPC-C](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tpcc_cpu_io-1655341130728.png)
...
![TiDB is the Bottleneck](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/tpcc_duration_idle-1655341130099.png)
...
![TiDB is the Bottleneck](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_query_long_idle-1655341129093.png)
...
在 TiDB 中，从输入查询文本到返回结果的[典型处理流程](https://docs.pingcap.com/zh/tidb/stable/sql-optimization-concepts)。

SQL 在 TiDB 内部的处理分为四个阶段，get token、parse、compile 和 execute：

- get token 阶段：通常只有几微秒的时间，可以忽略。除非 TiDB 单个实例的连接数达到的 [token-limit](https://docs.pingcap.com/zh/tidb/stable/tidb-configuration-file) 的限制，创建连接的时候被限流。
...
![Compile](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/long_compile-1655341129092.png)
...
![Execute](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/long_execute-1655341130608.png)
...
![Execute](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/execute_phase-1655341128851.png)
...
![Same Data Center](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/oltp_kv_tso-1655341129492.png)
...
![Cloud Env ](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_kv_tso-1655341130368.png)
...
![Cloud Env, TiDB Overloaded](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_kv_tso_overloaded-1655341130573.png)
...
![TiKV Write](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/store_apply-1655341130667.png)
...
![v5.3.0](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/v5.3.0_store_apply-1655341130382.png)

v5.4.0：

![v5.4.0](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/v5.4.0_store_apply-1655341129213.png)

**示例 2：Store Duration 瓶颈明显**

应用以上公式：10.1 ms ~= 9.81 ms + 0.304 ms，说明写请求的延迟瓶颈在 Store Duration。

![Store](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_store_apply-1655341129247.png)
...
![v5.3.0](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/v5.3.0_commit_append_apply-1655341130723.png)

v5.4.0：

![v5.4.0](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/v5.4.0_commit_append_apply-1655341130667.png)

**示例 2：Commit Log Duration 瓶颈明显的例子**

![Store](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/cloud_append_commit_apply-1655341130378.png)
...
- 如果 TiKV CPU 资源充足，且 TiDB 为 v5.3.0 及之后的版本，考虑启用 [`StoreWriter`](https://docs.pingcap.com/zh/tidb/stable/tune-tikv-thread-performance#tikv-线程池调优)。启用方式：`raftstore.store-io-pool-size: 1`。
...
![Store](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/import_dashboard-1655341129473.png)