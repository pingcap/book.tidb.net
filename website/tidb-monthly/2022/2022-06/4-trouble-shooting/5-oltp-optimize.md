...
> 注意：
>
> [Top SQL](https://docs.pingcap.com/zh/tidb/stable/top-sql) 和 [Continuous Profiling](https://docs.pingcap.com/zh/tidb/stable/continuous-profiling) 功能默认关闭，需要提前开启

在这些场景中，通过使用不同的 JDBC 配置运行同一个应用程序，你可以观察应用和数据库之间不同的交互方式将如何影响系统整体的性能，从而更好地掌握[开发 Java 应用使用 TiDB 的最佳实践](https://docs.pingcap.com/zh/tidb/stable/java-app-best-practices)。
...
![dashboard-for-query-interface](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/case1-1655341367901.png)
...
![flame-graph-for-query-interface](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/7.1-1655341373338.png)
...
![performance-overview-1-for-query-interface](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-1-1655341373199.png)
...
![performance-overview-2-for-query-interface](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/5-1655341367902.png)
...
![dashboard-for-maxPerformance](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/case2-1655341373603.png)

观察以下 TiDB 的火焰图，可以发现 SQL 语句执行中 Compile 和 Optimize 等函数 CPU 消耗占比高：

![flame-graph-for-maxPerformance](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/20220507-145257-1655341374388.jpg)
...
![performance-overview-1-for-maxPerformance](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-2-1655341372807.png)
...
![performance-overview-2-for-maxPerformance](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/9.1.1-1655341373388.png)

关键延迟指标变化如下：

![performance-overview-3-for-maxPerformance](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/9.2.2-1655341369374.png)
...
![flame-graph-for-PrepStmts](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/3.1.1-1655341371583.png)
...
![performance-overview-1-for-PrepStmts](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-3-1655341369374.png)
...
![performance-overview-1-for-PrepStmts](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/3-2-1655341373209.png)

主要延迟数据如下：

![performance-overview-2-for-PrepStmts](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/3.4-1655341368388.png)
...
![flame-graph-for-3-commands](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/4.2-1655341370323.png)
...
![performance-overview-1-for-3-commands](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-4-1655341373858.png)
...
![performance-overview-2-for-3-commands](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/4.4-1655341371188.png)

Compile 平均时间显著下降，从 374 us 下降到 53.3 us，因为 QPS 的上升，平均 execute 时间有所上升。

![performance-overview-3-for-3-commands](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/4.5-1655341370260.png)
...
![flame-graph-for-1-command](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/5.1.1-1655341372699.png)
...
![performance-overview-for-1-command](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-5-1655341368388.png)
...
![performance-overview-for-2-command](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-5-cpu-1655341371583.png)

关键的延迟指标如下：

![performance-overview-for-3-command](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-5-duration-1655341373200.png)
...
![flame-graph-for-rc-read](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/6.2.2-1655341371293.png)

#### Performance Overview 面板

使用 RC read 之后，QPS 从 30.9k 上升到 34.9k，每秒消耗的 tso wait 时间从 5.46 s 下降到 456 ms。

![performance-overview-1-for-rc-read](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-6-1655341370948.png)
...
![performance-overview-2-for-rc-read](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-6-cmd-1655341372619.png)

平均 TiDB CPU 上升为 603% (577%->603%)。

![performance-overview-3-for-rc-read](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-6-cpu-1655341369088.png)

关键延迟指标如下：

![performance-overview-4-for-rc-read](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-6-duration-1655341374298.png)
...
![flame-graph-for-table-cache](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/7.2-1655341372788.png)
...
![performance-overview-1-for-table-cache](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-7-1655341371153.png)
...
![performance-overview-2-for-table-cache](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-7-cpu-1655341368497.png)

Query 平均延迟从 533 us 下降到 313 us。execute 平均延迟从 466 us 下降到 250 us。

![performance-overview-3-for-table-cache](https://tidb-blog.oss-cn-beijing.aliyuncs.com/media/j-7-duration-1655341368463.png)
...
- 在性能分析和优化过程中，推荐使用 TiDB Dashboard （例如 Top SQL 功能和持续性能分析功能）和 Performance Overview 面板。
  ...
  - [Top SQL](https://docs.pingcap.com/zh/tidb/stable/top-sql) 功能允许你可视化地监控和探索数据库中各个 SQL 语句在执行过程中的 CPU 开销情况，从而对数据库性能问题进行优化和处理。
  - [持续性能分析功能](https://docs.pingcap.com/zh/tidb/stable/continuous-profiling) 可以持续地收集 TiDB、TiKV、PD 各个实例的性能数据。应用程序使用不同接口跟 TiDB 交互时，TiDB 的 CPU 消耗有着巨大的差距。
  - [Performance Overview 面板](https://docs.pingcap.com/zh/tidb/stable/grafana-performance-overview-dashboard) 提供了数据库时间的概览和 SQL 执行时间分解信息。借助这个面板，你可以进行基于数据库时间的性能分析和诊断，确定整个系统的性能瓶颈是否处于 TiDB 中。如果瓶颈在 TiDB 中，你可以通过数据库时间和延迟的分解，以及集群关键指标和资源使用情况，确认 TiDB 内部的性能瓶颈，并进行针对性的优化。
