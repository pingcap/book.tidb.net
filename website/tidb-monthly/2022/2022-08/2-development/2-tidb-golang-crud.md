---
title: TiDB 和 Golang 的简单 CRUD 应用程序 - TiDB 社区技术月刊
sidebar_label: TiDB 和 Golang 的简单 CRUD 应用程序
hide_title: true
description: 本文将展示如何使用 TiDB 和 Golang 来构造一个简单的 CRUD 应用程序。
keywords: [TiDB, Golang, CRUD, 应用程序, 云原生]
---
...
[创建免费集群](https://docs.pingcap.com/zh/tidb/stable/dev-guide-build-cluster-in-cloud#%E7%AC%AC-1-%E6%AD%A5%E5%88%9B%E5%BB%BA%E5%85%8D%E8%B4%B9%E9%9B%86%E7%BE%A4)。

### 使用本地集群

你可以部署一个本地测试的 TiDB 集群或正式的 TiDB 集群。详细步骤，请参考：

- [部署本地测试 TiDB 集群](https://docs.pingcap.com/zh/tidb/stable/quick-start-with-tidb#%E9%83%A8%E7%BD%B2%E6%9C%AC%E5%9C%B0%E6%B5%8B%E8%AF%95%E9%9B%86%E7%BE%A4)
...
## 第 3 步：运行代码[​](#第-3-步运行代码 "标题的直接链接")

本节将逐步介绍代码的运行方法。

### 第 3 步第 1 部分：go-sql-driver/mysql 表初始化[​](#第-3-步第-1-部分go-sql-drivermysql-表初始化 "标题的直接链接")
