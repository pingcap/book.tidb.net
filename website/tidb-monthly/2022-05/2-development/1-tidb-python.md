...
> 作者：**[ShawnYan](https://tidb.net/u/ShawnYan/post/all)** 发表于  **2022-05-13**

本文将介绍如何使用 Python 对 TiDB 进行应用开发，并做简单的 CRUD 演示。对应 [TiDB 6.0 Book Rush](https://asktug.com/t/topic/663914) 的[第二章](https://tidb.net/book/book-rush/developer-guide/)。
