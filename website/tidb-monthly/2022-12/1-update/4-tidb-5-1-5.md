---
title: TiDB 5.1.5 Release Notes - TiDB 社区技术月刊
sidebar_label: TiDB 5.1.5 Release Notes
hide_title: true
description: 本篇为 TiDB 5.1.5 Release Notes，包括兼容性变更、bug 修复等。
keywords: [TiDB, Release Notes, 5.1.5, 兼容性变更, 错误修复]
---
...
[TiDB 5.1.5 Release Notes](https://github.com/pingcap/docs-cn/blob/master/releases/release-5.1.5.md)更新于 2022/12/28 14:30:18: [add v5.1.5 release notes (#12314)](https://github.com/pingcap/docs-cn/commit/33460c6a2ec20e47e2b66e4d51caeeb5266b9345)
