...
![dashboard-for-query-interface](/img/book-rush/3-4-performance/case1.png)
...
![flame-graph-for-query-interface](/img/book-rush/3-4-performance/7.1.png)
...
![performance-overview-1-for-query-interface](/img/book-rush/3-4-performance/j-1.png)
...
![performance-overview-2-for-query-interface](/img/book-rush/3-4-performance/5.png)
...
![dashboard-for-maxPerformance](/img/book-rush/3-4-performance/case2.png)

观察以下 TiDB 的火焰图，可以发现 SQL 语句执行中 Compile 和 Optimize 等函数 CPU 消耗占比高：

![flame-graph-for-maxPerformance](/img/book-rush/3-4-performance/20220507-145257.jpg)
...
![performance-overview-1-for-maxPerformance](/img/book-rush/3-4-performance/j-2.png)
...
![performance-overview-2-for-maxPerformance](/img/book-rush/3-4-performance/9.1.1.png)

关键延迟指标变化如下：

![performance-overview-3-for-maxPerformance](/img/book-rush/3-4-performance/9.2.2.png)
...
![flame-graph-for-PrepStmts](/img/book-rush/3-4-performance/3.1.1.png)
...
![performance-overview-1-for-PrepStmts](/img/book-rush/3-4-performance/j-3.png)
...
![performance-overview-1-for-PrepStmts](/img/book-rush/3-4-performance/3-2.png)

主要延迟数据如下：

![performance-overview-2-for-PrepStmts](/img/book-rush/3-4-performance/3.4.png)
...
![flame-graph-for-3-commands](/img/book-rush/3-4-performance/4.2.png)
...
![performance-overview-1-for-3-commands](/img/book-rush/3-4-performance/j-4.png)
...
![performance-overview-2-for-3-commands](/img/book-rush/3-4-performance/4.4.png)

Compile 平均时间显著下降，从 374 us 下降到 53.3 us，因为 QPS 的上升，平均 execute 时间有所上升。

![performance-overview-3-for-3-commands](/img/book-rush/3-4-performance/4.5.png)
...
![flame-graph-for-1-command](/img/book-rush/3-4-performance/5.1.1.png)
...
![performance-overview-for-1-command](/img/book-rush/3-4-performance/j-5.png)
...
![performance-overview-for-2-command](/img/book-rush/3-4-performance/j-5-cpu.png)

关键的延迟指标如下：

![performance-overview-for-3-command](/img/book-rush/3-4-performance/j-5-duration.png)
...
![flame-graph-for-rc-read](/img/book-rush/3-4-performance/6.2.2.png)

#### Performance Overview 面板

使用 RC read 之后，QPS 从 30.9k 上升到 34.9k，每秒消耗的 tso wait 时间从 5.46 s 下降到 456 ms。

![performance-overview-1-for-rc-read](/img/book-rush/3-4-performance/j-6.png)
...
![performance-overview-2-for-rc-read](/img/book-rush/3-4-performance/j-6-cmd.png)

平均 TiDB CPU 上升为 603% (577%->603%)。

![performance-overview-3-for-rc-read](/img/book-rush/3-4-performance/j-6-cpu.png)

关键延迟指标如下：

![performance-overview-4-for-rc-read](/img/book-rush/3-4-performance/j-6-duration.png)
...
![flame-graph-for-table-cache](/img/book-rush/3-4-performance/7.2.png)
...
![performance-overview-1-for-table-cache](/img/book-rush/3-4-performance/j-7.png)
...
![performance-overview-2-for-table-cache](/img/book-rush/3-4-performance/j-7-cpu.png)

Query 平均延迟从 533 us 下降到 313 us。execute 平均延迟从 466 us 下降到 250 us。

![performance-overview-3-for-table-cache](/img/book-rush/3-4-performance/j-7-duration.png)
