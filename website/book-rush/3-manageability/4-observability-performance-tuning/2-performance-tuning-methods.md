...
> 作者：PingCAP 性能测试工程师：陈焕生 邵希茜 宋昱颖
...
![数据库时间分解图](/img/book-rush/3-4-performance/dashboard-diagnostics-time-relation.png)
...
![TPC-C](/img/book-rush/3-4-performance/tpcc_db_time.png)
...
![OLTP](/img/book-rush/3-4-performance/oltp_normal_db_time.png)
...
![OLTP](/img/book-rush/3-4-performance/oltp_long_compile_db_time.png)
...
![OLTP](/img/book-rush/3-4-performance/oltp_lock_contention_db_time.png)
...
![TPC-C](/img/book-rush/3-4-performance/tpcc_qps.png)
...
![OLTP-Query](/img/book-rush/3-4-performance/oltp_long_compile_qps.png)
...
![OLTP-Prepared](/img/book-rush/3-4-performance/oltp_prepared_statement_no_plan_cache.png)
...
![TPC-C](/img/book-rush/3-4-performance/tpcc_kv_conn.png)
...
![OLTP](/img/book-rush/3-4-performance/cloud_long_idle_kv_conn.png)
...
![TPC-C](/img/book-rush/3-4-performance/tidb_high_cpu.png)
...
![TPC-C](/img/book-rush/3-4-performance/tpcc_cpu_io.png)
...
![TiDB is the Bottleneck](/img/book-rush/3-4-performance/tpcc_duration_idle.png)
...
![TiDB is the Bottleneck](/img/book-rush/3-4-performance/cloud_query_long_idle.png)
...
![Compile](/img/book-rush/3-4-performance/long_compile.png)
...
![Execute](/img/book-rush/3-4-performance/long_execute.png)
...
![Execute](/img/book-rush/3-4-performance/execute_phase.png)
...
![Same Data Center](/img/book-rush/3-4-performance/oltp_kv_tso.png)
...
![Cloud Env ](/img/book-rush/3-4-performance/cloud_kv_tso.png)
...
![Cloud Env, TiDB Overloaded](/img/book-rush/3-4-performance/cloud_kv_tso_overloaded.png)
...
![TiKV Write](/img/book-rush/3-4-performance/store_apply.png)
...
![v5.3.0](/img/book-rush/3-4-performance/v5.3.0_store_apply.png)

v5.4.0：

![v5.4.0](/img/book-rush/3-4-performance/v5.4.0_store_apply.png)

**示例 2：Store Duration 瓶颈明显**

应用以上公式：10.1 ms ~= 9.81 ms + 0.304 ms，说明写请求的延迟瓶颈在 Store Duration。

![Store](/img/book-rush/3-4-performance/cloud_store_apply.png)
...
![v5.3.0](/img/book-rush/3-4-performance/v5.3.0_commit_append_apply.png)

v5.4.0：

![v5.4.0](/img/book-rush/3-4-performance/v5.4.0_commit_append_apply.png)

**示例 2：Commit Log Duration 瓶颈明显的例子**

![Store](/img/book-rush/3-4-performance/cloud_append_commit_apply.png)
...
![Store](/img/book-rush/3-4-performance/import_dashboard.png)
