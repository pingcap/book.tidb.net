...
<TabItem label="使用 go-sql-driver/mysql" value="get-code-sql-driver">
...
<TabItem label="使用 gorm（推荐）" value="get-code-gorm">
...
<TabItem label="使用 go-sql-driver/mysql" value="sql-driver-table-init-sql-driver">
...
<TabItem label="使用 gorm（推荐）" value="sql-driver-table-init-gorm">
...
<TabItem label="使用 go-sql-driver/mysql" value="tidb-cloud-sql-driver">
...
<TabItem label="使用 gorm（推荐）" value="tidb-cloud-gorm">
...
<TabItem label="使用 go-sql-driver/mysql" value="run-sql-driver">
...
<TabItem label="使用 gorm（推荐）" value="run-gorm">
