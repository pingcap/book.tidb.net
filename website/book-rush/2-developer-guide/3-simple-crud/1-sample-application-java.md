...
<TabItem label="使用 JDBC" value="get-code-jdbc">
...
<TabItem label="使用 Mybatis（推荐）" value="get-code-mybatis">
...
<TabItem label="使用 Hibernate（推荐）" value="get-code-hibernate">
...
<TabItem label="使用 JDBC" value="jdbc-table-init-jdbc">
...
<TabItem label="使用 Mybatis（推荐）" value="jdbc-table-init-mybatis">
...
<TabItem label="使用 Hibernate（推荐）" value="jdbc-table-init-hibernate">
...
<TabItem label="使用 JDBC" value="tidb-cloud-jdbc">
...
<TabItem label="使用 Mybatis（推荐）" value="tidb-cloud-mybatis">
...
<TabItem label="使用 Hibernate（推荐）" value="tidb-cloud-hibernate">
...
<TabItem label="使用 JDBC" value="run-jdbc">
...
<TabItem label="使用 Mybatis（推荐）" value="run-mybatis">
...
<TabItem label="使用 Hibernate（推荐）" value="run-hibernate">
