...
> Tip:
>
> 如果你希望使用 Spring Boot 进行 TiDB 应用程序的编写，可以查看 [Build the TiDB Application using Spring Boot](https://docs.pingcap.com/zh/tidb/dev/sample-application-spring-boot)。
